...
def reduce_images_to_percentage(directory, percentage):
    ...
    selected_dir = os.path.join(parent_directory, "train_90")
...
image_directory = "/media/william/mist2/william/Github/ultralytics/dataset/Cityscapes/yolo/images/train"  # Replace with the actual path to your image directory
