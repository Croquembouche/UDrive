...
if __name__ == "__main__":
    ...
    try:
        ...
        # env = VecMonitor(env)  # Wrap with VecMonitor to gather stats
        ...
        #     # Save the model
        #     model.save(f"/media/william/mist2/william/UDrive/Part2/stablebaselines3/savedModels/dqn_pedestrian_checkpoint{checkpoint_num}.zip")
        #     end = tm.time()

        #     print(f"Used {(end-start)/60} minutes for checkpoint {checkpoint_num}.")
