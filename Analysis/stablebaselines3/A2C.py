...
if __name__ == "__main__":
    ...
    try:
        ...
        model = A2C.load(f"/media/william/mist2/william/UDrive/Part2/stablebaselines3/savedModels/A2C/a2c_pedestrian_checkpoint2", env=env)
        # model.learn(total_timesteps=10000)

        # # Save the model
        # model.save("/media/william/mist2/william/UDrive/Part2/stablebaselines3/savedModels/A2C/a2c_pedestrian_checkpoint2.zip")
