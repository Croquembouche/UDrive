...
root_folder = "/media/william/blueicedrive/Github/UDrive/Analysis/nuScenes/images"  # Adjust this path as necessary
structure = build_json_structure(root_folder)
json_file_path = "/media/william/blueicedrive/Github/UDrive/Analysis/nuScenes/Analysis.json"  # Name of the JSON file to save
