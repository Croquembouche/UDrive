...
root_folder = "/mnt/nas/Kitti/UdriveAnalysis"  # Adjust this path as necessary
structure = build_json_structure(root_folder)
json_file_path = "/media/william/mist2/william/Github/UDrive/Analysis/Kitti/Analysis.json"  # Name of the JSON file to save
