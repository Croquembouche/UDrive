...
file = "/media/william/blueicedrive/Github/UDrive/Analysis/Kitti/Analysis.json"
traffic_signs_list = []
speciallanes_list = []
vehicletype_list = []
vehiclestate_list = []
...
with open("/media/william/blueicedrive/Github/UDrive/Analysis/Kitti/unifiedAnalysis.json", "w") as outfile:
