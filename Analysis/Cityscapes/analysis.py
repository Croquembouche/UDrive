...
# Load your data
file_path = '/media/william/blueicedrive/Github/UDrive/Analysis/Cityscapes/unifiedAnalysis.json'  # Update this with the actual file path
...
class DatasetAnalysis:
    ...
    def createBasicGraph(self):
        ...
        # Export to GEXF
        # nx.write_gexf(G, "/media/william/blueicedrive/Github/UDrive/Analysis/Cityscapes/analysis_directed.gexf")
        nx.write_graphml_lxml(G, "/media/william/blueicedrive/Github/UDrive/Analysis/Cityscapes/analysis_directed.graphml")
        # self.exportToCSV()
        return G
    ...
    def createRandomImageGraph(self, root_node):
        ...
        MEAN_CONNECTIONS = 24.843697478991597
        STD_DEV_CONNECTIONS = 2.3871025527942176
        MIN_CONNECTIONS = 19
    ...
    def randomAnalysis(self, similarity_threshold=0.9):
        ...
        for i in range(595):
            ...
            nx.write_graphml_lxml(temp, f"/media/william/blueicedrive/Github/UDrive/Analysis/Cityscapes/random_graphs/random_subgraph_directed-{i}.graphml")
    ...
    def compareImages(self, similarity_threshold=1.0): 
        ...
        for node, attrs in self.G.nodes(data=True):
            if attrs.get('type') == "image":
                ...
                nx.write_graphml_lxml(subgraph, f"/media/william/blueicedrive/Github/UDrive/Analysis/Cityscapes/image_subgraph/subgraph_directed{node}.graphml")
        ...
        # with open('/media/william/blueicedrive/Github/UDrive/Analysis/Cityscapes/results/imageJaccardSimilaritymatrix.csv', 'w', newline='') as f:
        #     writer = csv.writer(f)
        ...
        # with open('/media/william/blueicedrive/Github/UDrive/Analysis/Cityscapes/results/filtered_imageJaccardSimilaritymatrix.csv', 'w', newline='') as f:
        #     writer = csv.writer(f)
    ...
    def createRandomDataset(self):
        ...
        nx.write_graphml_lxml(random_dataset, f"/media/william/blueicedrive/Github/UDrive/Analysis/Cityscapes/randomdataset.graphml")
    ...
    def calculateCompositeScore(self):
        ...
        medium_risk = 289
        low_risk = 259
        c_max = 0.6807297605473205
        c_sigma = 0.07695574998783015
        c_max_random = 0.6574585635359117
        c_random_sigma = 0.050302812173567475
        density = 0.02
        density_random = 0.018
        modularity = 0.095
        modulartiy_random = 0.089
        num_community = 43
        num_community_random = 50
        J_image = 0.34410291605531096
        J_random = 0.1585358257111
        ...
        print(f"The Composite Score of Cityscapes is {S}. J_penalty: {w1*J_penalty}, M_penalty: {w2*M_penalty}, C_penalty: {w3*C_penalty}, D_penalty: {w4*D_penalty}, RiskDistribution_penalty: {RD_penalty}")
# The Composite Score of Cityscapes is 0.35248652763298316.. J_penalty: 0.2525156083924665, M_penalty: -0.18389189189189187 C_penalty: 0.045497857569434426, D_penalty: -0.06842105263157895, RiskDistribution_penalty: 0.1798938287989383
